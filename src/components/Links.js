...
const Links = () => {
  ...
  const padding = {
    ...
    return (
      ...
      </Card.Text><Button variant="primary"><a style={padding} href="https://wankko.fi">Visit Wankko</a></Button>
                    </Card.Body>
                    <Card.Footer>
      ...
      </Card.Text><Button variant="primary"><a style={padding} href="ahoniitty.github.io/">Visit My other github</a></Button>
                    </Card.Body>
                    <Card.Footer>
                        <small className="text-muted">Last updated 2020</small>
                    </Card.Footer>
